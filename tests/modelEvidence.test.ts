...
const technicalEvidence: ModelEvidenceConfig = {
  analysisReplay: {
    generatedAt: '2026-06-19T23:53:15.783Z',
  ...
  readiness: {
    ...
    generatedAt: '2026-06-19T23:53:10.532Z',
    loadMs: 3668,
    maxInferenceMs: 328,
    status: 'ready',
  },
...
describe('model evidence summary', () => {
  it('marks passing local model checks as technical-ready until real video validation exists', () => {
    ...
    expect(summary.metrics.map((metric) => metric.value)).toEqual(['3.7s', '324ms', '3/3']);
