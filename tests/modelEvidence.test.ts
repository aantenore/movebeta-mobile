...
const technicalEvidence: ModelEvidenceConfig = {
  analysisReplay: {
    generatedAt: '2026-06-19T23:41:43.629Z',
  ...
  readiness: {
    ...
    generatedAt: '2026-06-19T23:41:37.207Z',
    loadMs: 4824,
    maxInferenceMs: 324,
    status: 'ready',
  },
...
describe('model evidence summary', () => {
  it('marks passing local model checks as technical-ready until real video validation exists', () => {
    ...
    expect(summary.metrics.map((metric) => metric.value)).toEqual(['4.8s', '321ms', '3/3']);
