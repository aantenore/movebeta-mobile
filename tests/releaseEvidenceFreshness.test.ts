...
function bundle(generatedAt = '2026-06-20T10:00:00.000Z'): ReleaseEvidenceFreshnessReportBundle {
  return {
    ...
    externalEvidenceIntakeReport: report(generatedAt),
    externalEvidencePromotionReport: report(generatedAt),
    externalEvidenceValidationReport: report(generatedAt),
    featureCompletionReport: report(generatedAt),
    githubWorkflowReport: report(generatedAt),
    iosToolchainSetupPacket: report(generatedAt),
    iosToolchainReport: report(generatedAt),
    launchReadinessReport: report(generatedAt),
    licenseReviewPacket: report(generatedAt),
    releaseBlockerIssueFilingPlan: report(generatedAt),
    releaseBlockerIssueWebLinks: report(generatedAt),
    releaseBlockerIssuesReport: report(generatedAt),
    releaseBlockerProgressReport: report(generatedAt),
    modelAssetProvenanceReport: report(generatedAt),
    modelAnalysisReplayReport: report(generatedAt),
    modelDeliveryLifecycleReport: report(generatedAt),
    modelDownloadPlanReport: report(generatedAt),
    moveNetStaticAssetsReport: report(generatedAt),
    modelVerificationSuiteReport: report(generatedAt),
    moveNetReadinessReport: report(generatedAt),
    nativeQaEvidenceStarterReport: report(generatedAt),
    pwaReadinessReport: report(generatedAt),
    storeReleaseAccountRunbook: report(generatedAt),
    storeCredentialsSetupPacket: report(generatedAt),
    storeCredentialsReport: report(generatedAt),
    storeSubmissionPacket: report(generatedAt),
    vercelDeploymentHandoff: report(generatedAt),
