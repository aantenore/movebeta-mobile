...
const criticalPathConfigs: Record<CriticalPathKey, CriticalPathConfig> = {
  ...
  easCredentials: {
    ...
    commands: ['npm run release:credentials:starter', 'npm run release:credentials:doctor', 'npm run release:eas:strict'],
  ...
  easProject: {
    ...
    commands: ['npx eas-cli@latest init', 'npm run release:credentials:starter', 'npm run release:credentials:doctor'],
    dependencies: [],
    lane: 'store-accounts',
  ...
  iosBuild: {
    ...
    commands: ['npm run toolchain:ios', 'npm run native:ios:pods', 'npm run native:ios:doctor', 'npx expo run:ios --device'],
    dependencies: [],
