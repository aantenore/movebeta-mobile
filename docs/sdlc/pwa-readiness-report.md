...
Generated: 2026-06-23T15:24:39.691Z
...
| Model delivery policy | verified | Source and exported PWA include a versioned model-delivery policy, and the service worker uses it before model precache. |
