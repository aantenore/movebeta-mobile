...
Generated: 2026-06-25T08:27:09.421Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 15ms load, 308ms avg inference, 310ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 15ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 308ms avg and 310ms max inference are inside budget |
