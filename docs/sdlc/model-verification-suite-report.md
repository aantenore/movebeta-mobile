...
Generated: 2026-06-23T07:42:16.588Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 3939ms load, 327ms avg inference, 329ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 3939ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 327ms avg and 329ms max inference are inside budget |
