...
Generated: 2026-06-22T13:35:54.365Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 5366ms load, 316ms avg inference, 318ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 5366ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 316ms avg and 318ms max inference are inside budget |
