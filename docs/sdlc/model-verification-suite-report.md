...
Generated: 2026-06-25T15:11:21.459Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 13ms load, 312ms avg inference, 314ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 13ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 312ms avg and 314ms max inference are inside budget |
