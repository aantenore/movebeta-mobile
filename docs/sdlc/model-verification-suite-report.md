...
Generated: 2026-06-22T13:25:40.885Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 4747ms load, 327ms avg inference, 330ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 4747ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 327ms avg and 330ms max inference are inside budget |
