...
Generated: 2026-06-22T14:18:22.834Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 5390ms load, 333ms avg inference, 345ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 5390ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 333ms avg and 345ms max inference are inside budget |
