...
Generated: 2026-06-23T17:55:07.470Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 12ms load, 306ms avg inference, 321ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 12ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 306ms avg and 321ms max inference are inside budget |
