...
Generated: 2026-06-23T21:58:30.793Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 12ms load, 312ms avg inference, 325ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 12ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 312ms avg and 325ms max inference are inside budget |
