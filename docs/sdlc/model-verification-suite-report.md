...
Generated: 2026-06-22T14:12:06.439Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 6233ms load, 333ms avg inference, 336ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 6233ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 333ms avg and 336ms max inference are inside budget |
