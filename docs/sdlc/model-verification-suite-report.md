...
Generated: 2026-06-23T08:44:05.381Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 4108ms load, 332ms avg inference, 334ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 4108ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 332ms avg and 334ms max inference are inside budget |
