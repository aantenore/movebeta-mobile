...
Generated: 2026-06-22T13:58:27.722Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 5847ms load, 321ms avg inference, 331ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 5847ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 321ms avg and 331ms max inference are inside budget |
