...
Generated: 2026-06-22T09:31:54.509Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 8695ms load, 329ms avg inference, 336ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 8695ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 329ms avg and 336ms max inference are inside budget |
