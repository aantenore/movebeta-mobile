...
Generated: 2026-06-23T16:47:53.598Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 6333ms load, 336ms avg inference, 340ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 6333ms <= 25000ms load budget |
