...
Generated: 2026-06-25T09:35:18.532Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 9ms load, 305ms avg inference, 307ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 9ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 305ms avg and 307ms max inference are inside budget |
