...
Generated: 2026-06-23T12:25:14.432Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 4826ms load, 321ms avg inference, 323ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 4826ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 321ms avg and 323ms max inference are inside budget |
