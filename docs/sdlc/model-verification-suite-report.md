...
Generated: 2026-06-23T14:04:53.410Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 5220ms load, 336ms avg inference, 349ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 5220ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 336ms avg and 349ms max inference are inside budget |
