...
Generated: 2026-06-23T17:48:04.006Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 9ms load, 301ms avg inference, 304ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 9ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 301ms avg and 304ms max inference are inside budget |
