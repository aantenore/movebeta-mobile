...
Generated: 2026-06-20T03:23:23.951Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 4256ms load, 326ms avg inference, 329ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 4256ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 326ms avg and 329ms max inference are inside budget |
