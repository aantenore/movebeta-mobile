...
Generated: 2026-06-23T22:07:15.852Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 12ms load, 317ms avg inference, 322ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 12ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 317ms avg and 322ms max inference are inside budget |
