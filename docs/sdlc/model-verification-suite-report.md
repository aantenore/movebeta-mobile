...
Generated: 2026-06-23T22:55:48.884Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 12ms load, 296ms avg inference, 298ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 12ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 296ms avg and 298ms max inference are inside budget |
