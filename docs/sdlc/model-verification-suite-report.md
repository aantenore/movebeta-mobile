...
Generated: 2026-06-22T09:55:10.006Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 6046ms load, 324ms avg inference, 327ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 6046ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 324ms avg and 327ms max inference are inside budget |
