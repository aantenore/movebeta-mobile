...
Generated: 2026-06-23T18:00:44.390Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 10ms load, 300ms avg inference, 303ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 10ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 300ms avg and 303ms max inference are inside budget |
