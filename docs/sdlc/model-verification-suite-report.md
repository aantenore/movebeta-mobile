...
Generated: 2026-06-23T22:21:47.757Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 10ms load, 305ms avg inference, 307ms max inference |
