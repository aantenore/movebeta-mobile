...
Generated: 2026-06-25T12:54:44.206Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 13ms load, 315ms avg inference, 330ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 13ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 315ms avg and 330ms max inference are inside budget |
