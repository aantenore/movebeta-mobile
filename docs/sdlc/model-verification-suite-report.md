...
Generated: 2026-06-23T14:18:50.225Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 3928ms load, 330ms avg inference, 333ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 3928ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 330ms avg and 333ms max inference are inside budget |
