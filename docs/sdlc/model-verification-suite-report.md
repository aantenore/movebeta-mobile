...
Generated: 2026-06-23T16:04:38.663Z
...
| --- | --- | --- | --- | --- |
| MoveNet runtime budget | pass | engineering | `npm run model:movenet:readiness` | 5052ms load, 339ms avg inference, 348ms max inference |
| Model load budget | pass | engineering | `npm run model:movenet:readiness` | 5052ms <= 25000ms load budget |
| Inference budget | pass | engineering | `npm run model:movenet:readiness` | 339ms avg and 348ms max inference are inside budget |
