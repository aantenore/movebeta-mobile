...
export function buildReleaseHandoffPacket({
  ...
  return {
    artifacts: [
      ...
      artifact(rootDir, 'Cue validation dataset composition packet', 'docs/sdlc/cue-validation-dataset-composition-packet.json'),
      ...
      artifact(rootDir, 'External evidence apply report', 'docs/sdlc/external-evidence-apply-report.json'),
      ...
      artifact(rootDir, 'Model download plan report', 'docs/sdlc/model-download-plan-report.json'),
    ...
    commands: [
      ...
      command('cue-validation-composition', 'Cue-validation dataset composition packet', 'npm run validation:cue:composition', ['store']),
      command('cue-validation-compose-dataset', 'Cue-validation dataset composer', 'npm run validation:cue:composition -- --write-dataset', ['store']),
      ...
      command('external-evidence-apply', 'External evidence apply guard', 'npm run release:evidence:apply', [
        'internal',
        'store',
      ]),
