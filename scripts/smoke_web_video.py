...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        expect(page.get_by_text("128/131", exact=True)).to_be_visible()
        expect(page.get_by_text("82/84", exact=True)).to_be_visible()
        ...
        expect(page.get_by_text("npm run release:eas:strict", exact=True)).to_be_visible()
