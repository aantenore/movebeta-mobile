...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        expect(page.get_by_text('"rawVideoIncluded": false')).to_be_visible()
        ...
        expect(page.get_by_text("0 blocking checks")).to_be_visible()
        ...
        expect(page.get_by_text("Prepare packet")).to_be_visible()
        ...
        expect(page.get_by_text('"credentialValuesIncluded": false')).to_be_visible()
