...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        expect(page.get_by_text("134/137", exact=True)).to_be_visible()
        expect(page.get_by_text("88/90", exact=True)).to_be_visible()
        ...
        expect(page.get_by_text("[Release Blocker] EAS project binding")).to_be_visible()
