...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        expect(page.get_by_text("Reset before next hard try")).to_be_visible()
        expect(page.get_by_text("Training log", exact=True)).to_be_visible()
        expect(page.get_by_text("Drill follow-through", exact=True)).to_be_visible()
        ...
        expect(page.get_by_text("141/144", exact=True)).to_be_visible()
        expect(page.get_by_text("95/97", exact=True)).to_be_visible()
        ...
        expect(page.get_by_text('"tokenLikeValuesIncluded": false')).to_be_visible()
