...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        expect(page.get_by_text("159/162", exact=True)).to_be_visible()
        expect(page.get_by_text("113/115", exact=True)).to_be_visible()
        ...
        expect(page.get_by_text("backend", exact=True)).to_be_visible()
